...
from models.segformer_utils import resize
...
class mit_b1(MixVisionTransformer):
    def __init__(self, **kwargs):
        ...
        self.head = SegFormerHead(**decode_head)
        print("Initialized SegFormer Head for B1")
...
class mit_b4(MixVisionTransformer):
    def __init__(self, **kwargs):
        ...
        self.head = SegFormerHead(**decode_head)
        print("Initialized SegFormer Head for B4")
